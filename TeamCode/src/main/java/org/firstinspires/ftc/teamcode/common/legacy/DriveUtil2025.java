package org.firstinspires.ftc.teamcode.common.legacy;
...
/**
 * LEGACY: the 2025 generation of the drive utility, before drive/DriveUtil2026b. Nothing calls it
 * today; it is kept in legacy/ for reference. New code should use DriveUtil2026b, which takes a
 * RobotConfig instead of hardcoding motor directions, IMU orientation, and Pinpoint offsets.
 *
 * This class was trimmed on 2026-09-06 to the two methods its last OpModes called, init() and
