...
/**
 * LEGACY: the original per-robot config, replaced by common/RobotConfig. Nothing calls it today;
 * it is kept because its factory methods record the known-good Gear Girls and P3 values (motor
 * directions, IMU orientation, Pinpoint offsets). New code should use RobotConfig.
 */
