...
| K7, K8 second run | 2026-09-08 | Skyline, test2027bot config | pass, both | Both squares under the same 0.6 cap, both ending at heading 0: each came back onto the tape corner. Times and the two gaps in inches not written down (see the note under K10 when they are). |
