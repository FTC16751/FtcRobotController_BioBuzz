...
| I Drive Square (Pinpoint) | 2026-09-07 | Skyline, test2027bot config | drives the square, hunts | Every corner: large overshoot, then oscillation before settling. Cause was the untuned gains (P 0.019/mm saturates 2 in out); config moved to P3 Bot3's tuned numbers (P 0.0035, tolerance 18 mm, yaw 2.5/0/0.08) afterward, not yet re-run. |
